          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4 lg:gap-8 items-center">
            <div className="order-2 md:order-1 flex flex-col justify-center space-y-4 sm:space-y-6">
              ...
              <nav
                ...
                className="mt-5 grid grid-cols-2 gap-2 text-sm sm:w-fit sm:auto-cols-fr sm:grid-flow-col sm:grid-cols-none"
              >
                <a
                  href="https://oninova.net"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex min-h-11 items-center justify-center gap-2 bg-zinc-100 px-5 py-2.5 font-medium text-zinc-700 transition-colors hover:bg-black hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white dark:hover:text-black"
                >
                  <svg
                    aria-hidden="true"
                    className="h-5 w-[1.375rem] flex-shrink-0"
                    viewBox="0 0 88 80"
                    fill="currentColor"
                ...
                <a
                  ...
                  className="flex min-h-11 items-center justify-center gap-2 bg-zinc-100 px-5 py-2.5 font-medium text-zinc-700 transition-colors hover:bg-black hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white dark:hover:text-black"
                >
                  <svg aria-hidden="true" className="size-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="flex min-h-11 items-center justify-center gap-2 bg-zinc-100 px-5 py-2.5 font-medium text-zinc-700 transition-colors hover:bg-black hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-white dark:hover:text-black"
                >
                  <svg aria-hidden="true" className="size-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
