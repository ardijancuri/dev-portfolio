    ...
    <main className="min-h-screen bg-white dark:bg-black">
      ...
      <section className="min-h-[100svh] flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 pt-20 sm:pt-20 pb-12">
        <div className="max-w-7xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-10 lg:gap-20 items-center">
          ...
          <div className="mt-8 sm:mt-12">
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 sm:gap-4 text-sm sm:text-base">
              <a
