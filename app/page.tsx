...
export default function Home() {
  return (
    <main className="min-h-screen bg-white dark:bg-black">
      {/* Logo Header */}
      <header className="fixed top-0 left-0 right-0 z-50 py-4 sm:py-6 px-4">
      ...
      {/* Hero Section */}
      <section className="min-h-[100svh] flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-0">
        <div className="max-w-5xl w-full">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-zinc-600 dark:text-zinc-400 mb-6 sm:mb-8 max-w-3xl">
          ...
          <div className="text-base sm:text-lg md:text-xl text-zinc-500 dark:text-zinc-500 mb-8 sm:mb-12 max-w-3xl leading-relaxed space-y-4">
            <p>
              Co-founder of Oninova, a marketing agency and software development startup focused on building scalable digital products and performance-driven solutions.
            </p>
            <p>
              I work as a software engineer and full-stack developer, leading the technical side of the company, from system architecture and backend development to modern frontend applications. I enjoy turning business ideas into reliable, real-world software.
            </p>
            <p>
              At Oninova, we bridge technology and marketing to help businesses grow through custom software, automation, and data-driven digital strategies.
            </p>
          </div>

          {/* Social Links */}
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-sm sm:text-base max-w-2xl">
            <a
              href="https://www.linkedin.com/in/ardijan-curi/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-start gap-2 px-4 py-2 bg-black dark:bg-white text-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors font-medium"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-start gap-2 px-4 py-2 border-2 border-white dark:border-white text-black dark:text-white hover:bg-white hover:text-black dark:hover:bg-white dark:hover:text-black transition-colors font-medium"
            >
